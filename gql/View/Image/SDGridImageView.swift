...
struct SDGridImageView: View {
    @StateObject var imageTabViewModel: ImageTabViewModel
    ...
    init(images: [String]) {
        ...
        _imageTabViewModel = StateObject(wrappedValue: ImageTabViewModel(images: images))
    }
    ...
    var body: some View {
            ...
            .overlay(
                ZStack {
                    if imageTabViewModel.showingImages {
                        ImageTabView()
